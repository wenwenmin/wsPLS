...
More descriptions about wPLS can be seen in the file "README_R_markdown_file.html"(https://github.com/wenwenmin/wsPLS/blob/main/README_R_markdown_file.html).
