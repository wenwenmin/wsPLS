...
################################################################################
source("Function/Fun_compute_sd.R")
Res_data1$table_sd = Fun_comput_sd(Res_data1)
Res_data2$table_sd = Fun_comput_sd(Res_data2)  
Res_data3$table_sd = Fun_comput_sd(Res_data3)   
